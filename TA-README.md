...
the Tableau dashboard that addresses the prompt. There is the ability to filter on event
type and participant demographics, and the dashboard is embedded in the website. There is
a link to the dashboard on the footer of the website under a link called dashboard.
